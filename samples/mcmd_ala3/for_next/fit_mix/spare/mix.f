...
c**********************************************************
        ...
        print*,'    The number of virtual states and virtual-state '
        print*,'    partition should be exactly the same between  '
        print*,'    the current and the previous runs, because two '
        print*,'    polynomials are simply summed. '
        print*,'    Otherwize you get wrong result. '
        print*,'  '
...
c********
        ...
        if(iyesno .eq.0) then
          print*,'  The first md. '
          print*,'    No input polynomials from the previous run.'
          print*,'    Only currently made polynomials are used. '
...
c  In the first md (iyesno = 0), iord1 is not given.
        if(iyesno.eq.0) iord=iord2
        if(iyesno.eq.1) iord=max(iord1,iord2)
