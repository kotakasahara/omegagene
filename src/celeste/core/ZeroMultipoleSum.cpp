...
int ZeroMultipoleSum::calc_zero02pole_excess_alpha0(real &      ene_ele,
                                                    real &      grad_coeff,
                                                    const real &r12,
                                                    const real &r12_2,
                                                    const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero02pole_excess(real &      ene_ele,
                                             real &      grad_coeff,
                                             const real &r12,
                                             const real &r12_2,
                                             const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero04pole_excess_alpha0(real &      ene_ele,
                                                    real &      grad_coeff,
                                                    const real &r12,
                                                    const real &r12_2,
                                                    const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero04pole_excess(real &      ene_ele,
                                             real &      grad_coeff,
                                             const real &r12,
                                             const real &r12_2,
                                             const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero08pole_excess_alpha0(real &      ene_ele,
                                                    real &      grad_coeff,
                                                    const real &r12,
                                                    const real &r12_2,
                                                    const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero08pole_excess(real &      ene_ele,
                                             real &      grad_coeff,
                                             const real &r12,
                                             const real &r12_2,
                                             const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero16pole_excess_alpha0(real &      ene_ele,
                                                    real &      grad_coeff,
                                                    const real &r12,
                                                    const real &r12_2,
                                                    const real &r12_inv,
...
int ZeroMultipoleSum::calc_zero16pole_excess(real &      ene_ele,
                                             real &      grad_coeff,
                                             const real &r12,
                                             const real &r12_2,
                                             const real &r12_inv,
