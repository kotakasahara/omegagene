...
class ConstraintShake : public ConstraintObject {
  ...
  public:
    ...
    int shake_pair(real *in_crd, real *in_crd_prev, real_pw *in_mass_inv, PBC *pbc);
    int shake_trio(real *in_crd, real *in_crd_prev, real_pw *in_mass_inv, PBC *pbc);
    int shake_quad(real *in_crd, real *in_crd_prev, real_pw *in_mass_inv, PBC *pbc);
};
